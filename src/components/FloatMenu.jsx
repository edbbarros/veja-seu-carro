...
const FloatMenu = () => {
  return (
    ...
    // <footer class="fixed floatMenu bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow lg:justify-around md:flex md:items-center md:justify-between md:p-6 ">
